...
export default {
    ...
    validation: {
        choose_wallet: 'Per favore scegli un portafoglio',
        choose_category: 'Per favore scegli una categoria',
        insert_amount: 'Per favore inserisci un importo',
        choose_wallet_transfer: 'Per favore scegli un portafoglio per il trasferimento',
        choose_payee: 'Per favore scegli un beneficiario',
        insert_payee_name: 'Per favore inserisci il nome del beneficiario',
        choose_goal: 'Per favore scegli un obiettivo',
        create_goal_first: 'Crea prima un obiettivo per utilizzare questa funzione',
        wallets_must_be_different: 'I portafogli di origine e destinazione devono essere diversi',
